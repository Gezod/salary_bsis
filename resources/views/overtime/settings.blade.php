                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('overtime.settings.update') }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Rp</span>
                                                <input type="number" name="karyawan_rate"
                                                    value="{{ $settings->karyawan_rate }}"
                                                    class="form-control @error('karyawan_rate') is-invalid @enderror"
                                                    required>
                                            </div>
                                            @error('karyawan_rate')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Tarif per jam untuk karyawan yang bekerja
                                                lembur</small>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="number" name="minimum_minutes"
                                                value="{{ $settings->minimum_minutes }}"
                                                class="form-control @error('minimum_minutes') is-invalid @enderror"
                                                required>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <p class="text-success mb-0">
                                            @php
                                                $staffExample =
                                                    65 >= $settings->minimum_minutes
                                                        ? round(($settings->staff_rate * 65) / 60)
                                                        : 0;
                                            @endphp
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="text-success mb-0">
                                            @php
                                                $karyawanExample =
                                                    45 >= $settings->minimum_minutes
                                                        ? round(($settings->karyawan_rate * 45) / 60)
                                                        : 0;
                                            @endphp
