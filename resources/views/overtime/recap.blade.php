                ...
                <div class="py-4 animate-fade-in">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div
                                                class="d-flex justify-content-between align-items-center p-4 bg-primary bg-opacity-15 rounded mb-3 border border-primary border-opacity-25">
                                                <div class="d-flex align-items-center">
                                                ...
                                                <div class="text-end">
                                                    <div class="text-white fw-bold">
                                                        {{ $departmentStats['staff']['count'] }} orang</div>
                                                    <small class="text-white fw-semibold">
                                                        Rp
                                                        {{ number_format($departmentStats['staff']['total_pay'], 0, ',', '.') }}
                                                    </small>
                                                    @if ($departmentStats['staff']['total_minutes'] > 0)
                                                        <div class="text-white fw-semibold">
                                                            @php
                                                                $hours = floor(
                                                                    $departmentStats['staff']['total_minutes'] / 60,
                                                                );
                                                                $minutes =
                                                                    $departmentStats['staff']['total_minutes'] % 60;
                                                            @endphp
                                        ...
                                        <div class="col-12">
                                            <div
                                                class="d-flex justify-content-between align-items-center p-4 bg-success bg-opacity-15 rounded border border-success border-opacity-25">
                                                <div class="d-flex align-items-center">
                                                ...
                                                <div class="text-end">
                                                    <div class="text-white fw-bold">
                                                        {{ $departmentStats['karyawan']['count'] }} orang</div>
                                                    <small class="text-white fw-semibold">
                                                        Rp
                                                        {{ number_format($departmentStats['karyawan']['total_pay'], 0, ',', '.') }}
                                                    </small>
                                                    @if ($departmentStats['karyawan']['total_minutes'] > 0)
                                                        <div class="text-white fw-semibold">
                                                            @php
                                                                $hours = floor(
                                                                    $departmentStats['karyawan']['total_minutes'] / 60,
                                                                );
                                                                $minutes =
                                                                    $departmentStats['karyawan']['total_minutes'] % 60;
                                                            @endphp
                                    ...
                                    @if ($departmentStats['staff']['count'] > 0 || $departmentStats['karyawan']['count'] > 0)
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h4 class="text-warning mb-1">
                                                Rp
                                                {{ number_format($departmentStats['staff']['total_pay'] + $departmentStats['karyawan']['total_pay'], 0, ',', '.') }}
                                            </h4>
                                            <small class="text-muted">
                                                {{ $departmentStats['staff']['count'] + $departmentStats['karyawan']['count'] }}
                                                total lembur
                                            </small>
                                        </div>
                                    @else
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @forelse($topEmployees as $index => $data)
                                        <div
                                            class="d-flex align-items-center justify-content-between mb-3 p-3 bg-dark bg-opacity-25 rounded border border-secondary border-opacity-25">
                                            <div class="d-flex align-items-center">
                                                <div class="bg-gradient-warning rounded-circle d-flex align-items-center justify-content-center me-3 shadow-sm"
                                                    style="width: 32px; height: 32px;">
                                                    <span class="text-dark fw-bold"
                                                        style="font-size: 12px;">#{{ $index + 1 }}</span>
                                                </div>
                                                <div>
                                                    <div class="text-white fw-semibold small">
                                                        {{ $data['employee']->nama }}</div>
                                                    <small
                                                        class="badge bg-{{ $data['employee']->departemen === 'staff' ? 'primary' : 'success' }} bg-opacity-75">
                                            ...
                                            <div class="text-end">
                                                ...
                                                @endphp
                                                <div class="text-white fw-semibold small">{{ $hours }}j
                                                    {{ $minutes }}m</div>
                                                <small class="text-success">Rp
                                                    {{ number_format($data['total_pay'], 0, ',', '.') }}</small>
                                            </div>
                                        </div>
                                    @empty
                    ...
                    @if ($records->count() > 0)
                        <div class="card mt-4">
                            <div class="card-header">
                                <h5 class="card-title mb-0 text-white">
                                    <i class="bi bi-list-ul me-2"></i>Detail Lembur Bulan
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <div class="text-white fw-semibold">
                                                                {{ $record->employee->nama }}</div>
                                                            <small
                                                                class="text-muted">{{ ucfirst($record->employee->departemen) }}</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-white">{{ $record->formatted_date_with_day }}</td>
                                                <td class="text-white">{{ $record->formatted_duration }}</td>
                                                <td class="text-success fw-bold">{{ $record->formatted_overtime_pay }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
