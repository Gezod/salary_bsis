                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h3 class="mb-0">Rp {{ number_format($stats['total_pay'], 0, ',', '.') }}
                                            </h3>
                                        </div>
                                        <div class="bg-white bg-opacity-25 rounded-circle p-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @forelse($recentRecords as $record)
                                        <div
                                            class="d-flex align-items-center justify-content-between mb-3 p-3 bg-dark bg-opacity-25 rounded">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small
                                                        class="text-muted">{{ $record->formatted_date_with_day }}</small>
                                                </div>
                                            </div>
                                            <div class="text-end">
                                                <div class="text-white fw-semibold small">
                                                    {{ $record->formatted_duration }}</div>
