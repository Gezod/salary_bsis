                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="text-white fw-semibold">{{ $payroll->employee->nama }}</div>
                                                    <small class="text-muted">{{ ucfirst($payroll->employee->departemen) }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <a href="{{ route('payroll.recalculate', $payroll->id) }}" class="btn btn-sm btn-warning">
            ...
            <form method="POST" action="{{ route('payroll.generate') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        Sistem akan menghitung payroll untuk semua karyawan berdasarkan data absensi dan lembur bulan yang dipilih.
                    </div>
                </div>
