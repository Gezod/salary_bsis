                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row g-2 mb-3">
                                                ...
                                                <div class="col-6 text-success">{{ $payroll->formatted_overtime_pay }}
                                                </div>
                                                <div class="col-6 text-muted">Uang Makan:</div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @if ($payroll->status === 'paid')
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="text-white">{{ $payroll->payment_date->format('d M Y') }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    @else
                                        <form method="POST" action="{{ route('payroll.update.payment', $payroll->id) }}"
